...
__version__ = open("{{cookiecutter.project_name}}/version.py").readline().split(" = ")[1].replace('"', '').strip()
macros = []
...
extensions = [Extension("{{cookiecutter.project_name}}.src.{{cookiecutter.project_name}}",
                        ["{{cookiecutter.project_name}}/src/{{cookiecutter.project_name}}".pyx], # , language="c++",
